 ...
 * Page 2 (0x02): cadence/status — required background page; we send the
 * profile's *invalid* cadence encoding (a treadmill has no stride sensor)
 * and the same speed nibbles.
 *
